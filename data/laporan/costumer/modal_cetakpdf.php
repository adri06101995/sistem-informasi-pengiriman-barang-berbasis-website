	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="report/laporan_costumer.php" method="post" target="_blank">
				<table>
			...
			<div class="modal-footer">
				<a href="report/laporan_costumer.php" target="_blank" class="btn btn-primary btn-sm">Cetak Semua Data</a>
			</div>
		</div>
	</div>
</div>